...
struct SplashScreenView: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            .onAppear {
                withAnimation(.easeOut(duration: 2.0)) { cloudsIn = true }
                withAnimation(.easeOut(duration: 1.5)) { seaIn = true }
                withAnimation(.easeOut(duration: 2.5)) { shipIn = true }
                withAnimation(.easeIn(duration: 0.5)) { buttonIn = true }
